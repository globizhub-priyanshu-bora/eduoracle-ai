...
export default function DomainSelectionPage() {
  ...
  // The 5 domains you requested, paired with specific colors and icons
  const domains = [
    {
      id: "civil",
  ...
  const handleProceed = () => {
    if (selectedDomain) {
      // We pass the domain in the URL so the Entry Briefing and Live Quiz know what to load!
      router.push(`/battle?domain=${selectedDomain}`);
    }
  };
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className={`font-bold text-lg ${isSelected ? "text-white" : "text-neutral-200"}`}>
                    {domain.title}
                  </h3>
