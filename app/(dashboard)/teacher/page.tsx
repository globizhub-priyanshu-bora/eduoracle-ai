                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="bg-gray-950 border border-gray-800 p-3 md:p-4 rounded-lg">
                    ...
                    <p className="text-xs md:text-sm text-gray-300">
                      Shift lecture focus from theoretical concepts to practical
                      numerical calculations regarding {commonTopic}.
                    </p>
                  </div>
                  <div className="bg-gray-950 border border-gray-800 p-3 md:p-4 rounded-lg">
                    ...
                    <p className="text-xs md:text-sm text-gray-300">
                      Push targeted prerequisite assignments exclusively to{" "}
                      {silentStrugglers.length} flagged students via their
                      Student Growth Engine dashboard.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="overflow-x-auto min-h-[300px]">
          {isFetchingData ? (
            <div className="flex flex-col items-center justify-center h-[300px] text-gray-500">
              ...
              <p>Syncing Cognitive Graph via EduOracle AI...</p>
            </div>
          ) : (
