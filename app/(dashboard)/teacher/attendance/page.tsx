...
const mockStudents = [
  {
    id: "S01",
    name: "Rahul Das",
    email: "rahul@edugobiz.com",
    avatarColor: "from-blue-500 to-indigo-600",
  },
  {
    id: "S02",
    name: "Priya Sharma",
    email: "priya@edugobiz.com",
    avatarColor: "from-purple-500 to-pink-600",
  },
  {
    id: "S03",
    name: "Amit Kalita",
    email: "amit@edugobiz.com",
    avatarColor: "from-red-500 to-orange-600",
  },
  {
    id: "S04",
    name: "Sneha Menon",
    email: "sneha@edugobiz.com",
    avatarColor: "from-green-500 to-emerald-600",
  },
  {
    id: "S05",
    name: "Vikram Bora",
    email: "vikram@edugobiz.com",
    avatarColor: "from-orange-500 to-yellow-600",
  },
  {
    id: "S06",
    name: "Neha Saikia",
    email: "neha@edugobiz.com",
    avatarColor: "from-red-500 to-orange-600",
  },
  {
    id: "S07",
    name: "Rohan Baruah",
    email: "rohan@edugobiz.com",
    avatarColor: "from-blue-500 to-cyan-600",
  },
  {
    id: "S08",
    name: "Anjali Thakuria",
    email: "anjali@edugobiz.com",
    avatarColor: "from-purple-500 to-indigo-600",
  },
  {
    id: "S09",
    name: "Karan Varma",
    email: "karan@edugobiz.com",
    avatarColor: "from-red-500 to-orange-600",
  },
  {
    id: "S10",
    name: "Pooja Nath",
    email: "pooja@edugobiz.com",
