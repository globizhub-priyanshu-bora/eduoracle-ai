...
const mockStudents = [
  {
    id: "S01",
    name: "Rahul Das",
    email: "rahul@eduoracle.com",
    avatarColor: "from-blue-500 to-indigo-600",
  },
  {
    id: "S02",
    name: "Priya Sharma",
    email: "priya@eduoracle.com",
    avatarColor: "from-purple-500 to-pink-600",
  },
  {
    id: "S03",
    name: "Amit Kalita",
    email: "amit@eduoracle.com",
    avatarColor: "from-red-500 to-orange-600",
  },
  {
    id: "S04",
    name: "Sneha Menon",
    email: "sneha@eduoracle.com",
    avatarColor: "from-green-500 to-emerald-600",
  },
  {
    id: "S05",
    name: "Vikram Bora",
    email: "vikram@eduoracle.com",
    avatarColor: "from-orange-500 to-yellow-600",
  },
  {
    id: "S06",
    name: "Neha Saikia",
    email: "neha@eduoracle.com",
    avatarColor: "from-red-500 to-orange-600",
  },
  {
    id: "S07",
    name: "Rohan Baruah",
    email: "rohan@eduoracle.com",
    avatarColor: "from-blue-500 to-cyan-600",
  },
  {
    id: "S08",
    name: "Anjali Thakuria",
    email: "anjali@eduoracle.com",
    avatarColor: "from-purple-500 to-indigo-600",
  },
  {
    id: "S09",
    name: "Karan Varma",
    email: "karan@eduoracle.com",
    avatarColor: "from-red-500 to-orange-600",
  },
  {
    id: "S10",
    name: "Pooja Nath",
    email: "pooja@eduoracle.com",
...
export default function AttendancePage() {
  ...
  >(
    mockStudents.reduce(
      (acc, student) => ({ ...acc, [student.id]: "unmarked" }),
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-6">
        <div>
          ...
          <div className="flex items-center gap-2 mt-2 text-neutral-400">
            ...
            <span className="text-sm font-medium">{todayDate} • ECE-401</span>
          </div>
        </div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-blue-200/70 mt-1 leading-relaxed">
            <strong className="text-white">Amit Kalita</strong> and{" "}
            <strong className="text-white">Karan Varma</strong> have a 75%
            probability of being late today based on historical Friday patterns.
            Their "At Risk" academic status correlates highly with this
            absenteeism.
          </p>
        </div>
      </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-white shadow-inner bg-gradient-to-br ${student.avatarColor}`}
                  >
                ...
                <div className="flex bg-neutral-950 p-1 rounded-xl border border-white/10 shrink-0">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold transition-all ${
                      status === "present"
                        ? "bg-green-500/20 text-green-400 shadow-[inset_0_0_8px_rgba(34,197,94,0.3)]"
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold transition-all ${
                      status === "late"
                        ? "bg-yellow-500/20 text-yellow-400 shadow-[inset_0_0_8px_rgba(234,179,8,0.3)]"
                        : "text-neutral-500 hover:text-neutral-300"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold transition-all ${
                      status === "absent"
                        ? "bg-red-500/20 text-red-400 shadow-[inset_0_0_8px_rgba(239,68,68,0.3)]"
                        : "text-neutral-500 hover:text-neutral-300"
                    }`}
                  >
      ...
      <AnimatePresence>
        {stats.unmarked < mockStudents.length && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 50 }}
            className="fixed bottom-6 left-0 right-0 md:left-[280px] flex justify-center z-50 px-4"
          >
            <div className="bg-neutral-900 border border-white/10 shadow-2xl rounded-2xl p-2 flex items-center gap-4 backdrop-blur-xl">
              <div className="px-4 text-sm font-medium text-neutral-300 hidden sm:block">
                <span className="text-white font-bold">
                  {mockStudents.length - stats.unmarked}
                </span>{" "}
                / {mockStudents.length} marked
              </div>
              <button
                onClick={handleSave}
