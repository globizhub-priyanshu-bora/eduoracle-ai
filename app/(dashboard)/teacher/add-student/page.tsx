    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-neutral-400 mt-1">
          Provision a new digital twin in the EduGlobiz tracking system.
        </p>
      </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="rahul@edugobiz.com"
                  className="w-full bg-neutral-950 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white placeholder-neutral-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="ISRO Scientist 'SC'">
                      ISRO Scientist 'SC'
                    </option>
            ...
            <div className="flex items-center justify-between p-4 bg-red-500/5 border border-red-500/20 rounded-xl">
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-1">
                  Force AI to monitor this student with elevated priority.
                </p>
              </div>
            ...
            <button
              type="submit"
              disabled={
                isSubmitting || isSuccess || !formData.name || !formData.email
              }
        ...
        >
          <div className="sticky top-8 space-y-4">
            ...
            <div className="relative p-6 rounded-3xl bg-neutral-900 border border-white/10 shadow-2xl overflow-hidden">
              ...
              <div
                className={`absolute -top-20 -right-20 w-48 h-48 rounded-full blur-[80px] opacity-30 ${formData.isStruggler ? "bg-red-500" : "bg-blue-500"}`}
              />
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-neutral-400 truncate mb-6">
                  {formData.email || "student@edugobiz.com"}
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/5">
                    ...
                    <span
                      className={`text-xs font-bold ${formData.weakSubject !== "None" ? "text-orange-400" : "text-white"}`}
                    >
                ...
                <div className="mt-6 pt-4 border-t border-white/10">
                  ...
                  <p className="text-xs text-neutral-500 mt-2 text-center italic">
                    Awaiting first diagnostic exam...
                  </p>
                </div>
              </div>
            </div>
