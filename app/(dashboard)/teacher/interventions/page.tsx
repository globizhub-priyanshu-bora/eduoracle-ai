...
const activeAlerts = [
  {
    ...
    severity: "Critical",
    aiStrategy:
      "Deploy an interactive 5-step remedial module focusing on switch matrix architectures. Bypass standard quizzes.",
  ...
  },
  {
    ...
    severity: "High",
    aiStrategy:
      "Assign dynamic visual K-Map solver exercises. Schedule mandatory 15-minute 1-on-1 review.",
    status: "Pending Action",
  },
  {
    id: "INT-03",
    ...
    severity: "High",
    aiStrategy:
      "Draft and stage early-warning email to student and academic advisor outlining specific knowledge gaps.",
    status: "Deployed",
  },
];
    ...
    <div className="min-h-screen p-6 md:p-10 max-w-7xl mx-auto space-y-8">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-6">
        <div>
          ...
          <p className="text-neutral-400 mt-2">
            AI-generated remediation strategies for at-risk students.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl bg-neutral-900/50 border border-white/5 flex items-center gap-4 backdrop-blur-md">
          ...
          <div>
            <p className="text-2xl font-black text-white">
              {alerts.filter((a) => a.status === "Pending Action").length}
            </p>
        ...
        <div className="p-5 rounded-2xl bg-neutral-900/50 border border-white/5 flex items-center gap-4 backdrop-blur-md">
          ...
          <div>
            <p className="text-2xl font-black text-white">
              {alerts.filter((a) => a.status === "Deployed").length}
            </p>
            <p className="text-xs font-bold text-neutral-500 uppercase tracking-wider">
              Strategies Deployed
            </p>
      ...
      <div className="space-y-4">
        <h2 className="text-sm font-bold text-neutral-500 uppercase tracking-[0.2em] px-2 mb-4">
          Action Required
        </h2>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-400 mt-1">
                      <strong className="text-neutral-200">Trigger:</strong>{" "}
                      {alert.trigger}
                    </p>
