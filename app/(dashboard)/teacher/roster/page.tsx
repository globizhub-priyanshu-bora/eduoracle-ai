      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-6">
        <div>
          ...
          <p className="text-neutral-400 mt-2">
            ECE-401 Advanced Systems • {mockRoster.length} Enrolled Students
          </p>
        </div>
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-2">
                          {student.weakSubjects.length > 0 ? (
                            student.weakSubjects.map((sub, idx) => (
                              <span
                                key={idx}
                                className="bg-red-500/10 text-red-400 border border-red-500/20 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-[inset_0_0_10px_rgba(239,68,68,0.1)]"
                              >
                      ...
                      <td className="p-5">
                        <div className="flex items-center gap-4 w-48">
                          <div className="flex-1 h-1.5 bg-neutral-800 rounded-full overflow-hidden">
                            <motion.div
                              ...
                              className={`h-full rounded-full ${
                                student.healthScore >= 80
                                  ? "bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)]"
                                  : student.healthScore >= 55
                          ...
                          <span
                            className={`font-black w-8 text-right ${
                              student.healthScore >= 80
                                ? "text-green-400"
                                : student.healthScore >= 55
                                  ? "text-orange-400"
